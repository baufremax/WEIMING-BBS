...
try {
	...
	String postSql = "select * from posts natural join section where sectionName = ?";
...
<table>
	...
	<tr>
		...
		<td></td>
		<td><a href="post_delete.jsp?postID=<%= result.getString("postID") %>&sectionName=<%= request.getParameter("sectionName")%>">Delete</a></td>
	</tr>
	<% } 
	try
      {
