 ...
 * Generated at: 2018-11-30 03:06:04 UTC
...
catch (Exception e)
{
    e.printStackTrace();
      ...
      out.write("\t</tr>\n");
      out.write("\t</table>\n");
      out.write("\t<h2>Select the section you want to access.</h2>\n");
      out.write("\t<table>\n");
      out.write("\t");
 while (result.next()) { 
      out.write("\n");
      out.write("\t<tr>\n");
      out.write("\t\t<td><a href=\"section_action.jsp?sectionName=");
      out.print( result.getString("sectionName"));
      out.write('"');
      out.write('>');
      out.print( result.getString("sectionName") );
      out.write("</a></td>\n");
